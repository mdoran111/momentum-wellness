    ...
    <div className="pt-16 pb-24 min-h-screen bg-background">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-16 flex flex-col items-center">
          <h1 className="text-2xl md:text-4xl lg:text-5xl font-extrabold font-heading text-primary mb-6 tracking-tight uppercase whitespace-nowrap">MOMENTUM built with you in mind.</h1>
