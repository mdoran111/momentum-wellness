      ...
      <section className="py-24 md:py-32 lg:py-40 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full">
          <div
            ...
            style={{
              backgroundImage: `radial-gradient(circle at 20% 50%, rgba(16,185,129,0.03) 0%, transparent 40%), radial-gradient(circle at 80% 50%, rgba(255,255,255,0.01) 0%, transparent 40%)`
            }}
          ></div>
        </div>
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <span className="text-sm font-bold tracking-[0.3em] uppercase text-white/20 mb-6 block">
              Get Started
            </span>
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-8 leading-[1.05] tracking-tight">
              Ready to Bring{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-400">
                Momentum Wellness
              </span>{" "}
            ...
            <p className="text-xl text-white/40 font-light leading-relaxed mb-6 max-w-2xl mx-auto">
              If your company is ready to support employee health in a more structured, modern, and engaging way, we’d love to talk.
            </p>
            <p className="text-lg text-white/30 font-light leading-relaxed mb-12 max-w-2xl mx-auto">
              We work with companies that want more than a generic wellness solution. Our employee wellness programs are designed to help teams build better habits, stay accountable, and create lasting momentum.
            </p>
