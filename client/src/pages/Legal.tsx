  ...
  return (
    <div className="pt-16 pb-24 min-h-screen bg-background">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="mb-12">
          <h1 className="text-4xl font-bold font-heading text-primary mb-4">Legal Information</h1>
        ...
        <div className="space-y-16">
          <section>
            <h2 className="text-2xl font-bold font-heading text-primary mb-6 pb-2 border-b">Terms of Service</h2>
            <div className="prose prose-slate text-muted-foreground">
              <p>Last updated: {new Date().toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}</p>
              
              <h3 className="text-lg font-bold text-primary mt-6 mb-2">1. Acceptance of Terms</h3>
              ...
              <h3 className="text-lg font-bold text-primary mt-6 mb-2">2. Medical Disclaimer</h3>
              ...
              <h3 className="text-lg font-bold text-primary mt-6 mb-2">3. Subscription and Billing</h3>
          ...
          <section>
            <h2 className="text-2xl font-bold font-heading text-primary mb-6 pb-2 border-b">Privacy Policy</h2>
            <div className="prose prose-slate text-muted-foreground">
              <p>Last updated: {new Date().toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}</p>
              
              <h3 className="text-lg font-bold text-primary mt-6 mb-2">1. Information We Collect</h3>
              ...
              <h3 className="text-lg font-bold text-primary mt-6 mb-2">2. How We Use Your Information</h3>
